...
import com.example.android.utils.MOVIE_VIEW_TYPE
import com.example.android.utils.SERIES_VIEW_TYPE
...
class CastAdapter(private val clickListener: CastClickListener) :
    ListAdapter<DataItem, RecyclerView.ViewHolder>(CastDiffUtillCallback()) {
